...
<!-- SCRIPT PARA CAMBIAR SEGUN INICIO DE SESION Y PREMIUM -->
<script>
    const isLoggedIn = true; // Sesion -->
    const isPremium = true; // Premium -->
    // Remplaza con la conexion a back 
    ...
    if (!isLoggedIn) {
        ...
        userSection.innerHTML = `
            <div class="position-relative me-3">
                <a href="chat.jsp">
                    <img src="img/message.png" alt="Messages" width="24">
                </a>
                <span class="position-absolute top-0 start-100 translate-middle p-1 bg-danger border border-light rounded-circle"></span>
            </div>
            <a href="perfil.jsp">
                <img src="img/profileph.png" alt="Profile" width="30" height="30" class="rounded-circle">
            </a>
        `;
    }
