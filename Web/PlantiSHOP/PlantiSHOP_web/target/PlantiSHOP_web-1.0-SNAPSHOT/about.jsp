...
<body>
    ...
    <!--
    La pagina de about.jsp solo contiene la estructura del modelo de negocio de 
    PlantiSHOP y explica al final los metodos de pago, para esta no ocupas conexion
    con backend.
    -->
