                ...
                try (Statement s = c.createStatement()) {
                    ...
                    if (!r.next() && (ex.equals("gpj") || ex.equals("gepj") || ex.equals("gepjp") || ex.equals("fifj") || ex.equals("pjp") || ex.equals("ruc") || ex.equals("oci") || ex.equals("gvs") || ex.equals("fig") || ex.equals("gnp") || ex.equals("gnpa"))) {
                        ...
                        if (Boolean.parseBoolean(request.getParameter("x"))) {
                            s.executeUpdate("INSERT INTO Producto(CE,N,D,T,P,Img,Cupo) VALUES ('"+request.getSession().getAttribute("u")+"','"+request.getParameter("n")+"','"+request.getParameter("txt")+"','"+request.getParameter("t")+"',"+request.getParameter("p")+",'"+img.getSubmittedFileName()+"',"+request.getParameter("c")+")");
