...
<%
    try {
        if (!((String) session.getAttribute("u")).equals("alonmc237@gmail.com") && !((String) session.getAttribute("u")).equals("fernandomarlon2007.1976@gmail.com") && !((String) session.getAttribute("u")).equals("juanpagon16@gmail.com") && !((String) session.getAttribute("u")).equals("agarciagael93@gmail.com")) {
            out.print("<script>alert('Lo sentimos, NO eres un Administrador de PlantiSHOP... por lo que NO puedes hacer uso de este APARTADO...');</script>");
            out.print("<script>location.assign('../../Interfaz.jsp?x=E');</script>");
        } else {
...
<html lang="es-MX">
    ...
    <body>
        ...
        <a href="../../Interfaz.jsp?x=E">SALIR</a>
        <hr>
        <table>
